...
class TestAxios extends Component {
    ...
    handelUpdate = () => {
        console.log(' Update user from axios start handel Delete by id ');
        axios.put(`http://10.0.3.2:3000/users/${this.state.id}`,
            {
    ...
    return (
        ...
        >
                ...
                <Content>
                    <Form>
                        <Field 
                            title='Please Enter the ID of the user to update:'
